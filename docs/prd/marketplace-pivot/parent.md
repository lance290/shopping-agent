# Parent PRD: BuyAnything.ai Marketplace Pivot

_Source copy of the parent PRD for traceability._
...
### Transaction Modes
The platform supports three marketplace segments: **B2C**, **B2B**, and **C2C**.

### Market Dynamics
This is conceptually a "reverse eBay": buyers post needs (RFPs) and sellers compete to win by optimizing price, value, and reputation signals.
