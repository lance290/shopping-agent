"""eBay Browse API adapter for provider query mapping."""
...
class EbayBrowseQueryAdapter(ProviderQueryAdapter):
    ...
    def build_query(self, intent: SearchIntent) -> ProviderQuery:
        ...
        if intent.condition and intent.condition != "any":
            ...
            filters["condition"] = condition_map.get(intent.condition, intent.condition)
