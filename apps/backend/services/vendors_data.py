"""
Static vendor data — early-adopter providers, checklist, email template, aliases.
Extracted from services/vendors.py to keep functions separate from data.
"""
from typing import List, Dict
from services.vendors_models import Vendor, ChecklistItem
...
VENDORS: Dict[str, List[Vendor]] = {
    "private_aviation": [
        ...
        Vendor(
            ...
            provider_type="Advisory / Part 135 operational support",
            fleet="Provides Part 135 operational support (DO/SMS/maintenance/safety); may source or refer charter options.",
            jet_sizes="Varies (advisory capacity)",
            wifi="Varies by referred operator/tail.",
            starlink="Varies by referred operator/tail.",
            pricing_info="Varies (quote-based).",
            availability="Contact for availability.",
            safety_certs="Part 135 operational expertise; can advise on safety/compliance standards.",
            notes="Specializes in Part 135 operational support. May source charter or refer to vetted operators.",
        ...
        Vendor(
            name="Brett Driscoll",
            company="Brett Driscoll Aviation",
            email="brett.driscoll2@gmail.com",
            category="private_aviation",
            image_url="https://www.google.com/s2/favicons?domain=gmail.com&sz=128",
            website="",
            provider_type="Broker / Independent",
            fleet="Independent broker — sources aircraft from operator network.",
            jet_sizes="All classes depending on sourced aircraft",
            wifi="Varies by operator/tail.",
            starlink="Varies by operator/tail.",
            pricing_info="Varies by sourced operator/tail; broker quote.",
            availability="Varies by sourced operator/tail.",
            safety_certs="Broker — verify operator/Part 135 certificate and safety ratings.",
            notes="Independent broker contact. Confirm operating carrier + tail number + Part 135 certificate.",
            source_urls="",
            last_verified="2026-02-07",
        ),
    ],
