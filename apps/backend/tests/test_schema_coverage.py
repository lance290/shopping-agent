...
TABLES_CREATED_FROM_SCRATCH = {"vendor", "request_spec", "brand_portal_token", "campaign", "coupon_campaign", "group_thread", "receipt", "row_comment", "row_reaction"}
...
ORIGINAL_COLUMNS = {
    ...
    # Pop V2 — WalletTransaction, Receipt, Referral (all original)
    ("wallet_transaction", "user_id"), ("wallet_transaction", "amount_cents"),
    ("wallet_transaction", "description"), ("wallet_transaction", "source"),
    ("wallet_transaction", "receipt_id"), ("wallet_transaction", "created_at"),
    ("receipt", "user_id"), ("receipt", "project_id"), ("receipt", "image_hash"),
    ("receipt", "status"), ("receipt", "credits_earned_cents"),
    ("receipt", "items_matched"), ("receipt", "raw_items_json"), ("receipt", "created_at"),
    ("referral", "referrer_user_id"), ("referral", "referred_user_id"),
    ("referral", "ref_code"), ("referral", "status"), ("referral", "created_at"),
    ("referral", "activated_at"),
    # PopSwap — all original
    ("pop_swap", "brand_name"), ("pop_swap", "product_name"),
    ("pop_swap", "original_product"), ("pop_swap", "category"),
    ("pop_swap", "provider"), ("pop_swap", "provider_offer_id"),
    ("pop_swap", "savings_cents"), ("pop_swap", "redemption_type"),
    ("pop_swap", "redemption_url"), ("pop_swap", "barcode"), ("pop_swap", "image_url"),
    ("pop_swap", "description"), ("pop_swap", "terms"), ("pop_swap", "is_active"),
    ("pop_swap", "expires_at"), ("pop_swap", "created_at"),
    # PopSwapClaim — all original
    ("pop_swap_claim", "swap_id"), ("pop_swap_claim", "user_id"),
    ("pop_swap_claim", "row_id"), ("pop_swap_claim", "receipt_id"),
    ("pop_swap_claim", "status"), ("pop_swap_claim", "claimed_at"),
    ("pop_swap_claim", "redeemed_at"),
