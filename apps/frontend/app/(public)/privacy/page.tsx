export default function PrivacyPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <p className="text-sm text-ink-muted mb-12">Last updated: February 2026</p>
      ...
      <div className="prose prose-gray max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-xl font-semibold text-ink mb-3">6. Vendor Privacy</h2>
          <p className="text-ink-muted leading-relaxed">
        ...
        <section>
          ...
          <p className="text-ink-muted leading-relaxed">
            For privacy questions, contact us at <a href="mailto:privacy@buyanything.ai" className="text-accent-blue hover:underline">privacy@buyanything.ai</a>.
          </p>
        </section>
      </div>
    </div>
