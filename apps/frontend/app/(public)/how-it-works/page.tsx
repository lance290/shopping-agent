...
export default function HowItWorksPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-4xl font-bold text-ink text-center mb-4">How BuyAnything Works</h1>
      <p className="text-lg text-ink-muted text-center mb-16 max-w-2xl mx-auto">
      ...
      <div className="space-y-16">
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="w-20 h-20 bg-gold/10 rounded-2xl flex items-center justify-center shrink-0">
            <Search className="h-10 w-10 text-gold-dark" />
          </div>
          <div>
            <h2 className="text-2xl font-semibold text-ink mb-3">1. Tell us what you need</h2>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="w-20 h-20 bg-gold/10 rounded-2xl flex items-center justify-center shrink-0">
            <Zap className="h-10 w-10 text-gold-dark" />
          </div>
          <div>
            <h2 className="text-2xl font-semibold text-ink mb-3">2. We search everywhere simultaneously</h2>
            <p className="text-ink-muted leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-ink mb-3">3. You choose</h2>
            <p className="text-ink-muted leading-relaxed">
