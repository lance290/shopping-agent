export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-4xl font-bold text-ink mb-8">About BuyAnything</h1>
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <h2 className="text-2xl font-semibold text-ink mt-8 mb-4">The Problem We Solve</h2>
        <p className="text-ink-muted leading-relaxed mb-6">
        ...
        <h2 className="text-2xl font-semibold text-ink mt-8 mb-4">How We&apos;re Different</h2>
        ...
        <h2 className="text-2xl font-semibold text-ink mt-8 mb-4">Our Vendor Network</h2>
        <p className="text-ink-muted leading-relaxed mb-6">
